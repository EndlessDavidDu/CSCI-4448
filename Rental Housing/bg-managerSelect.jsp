...
{%>删除<%}%>
   ...
   <tr align="center">
    ...
    <td width="25%"><%if((number+1)==1){%> previous page<%}else{%><a href="managerAction.do?action=1&i=<%=number-1%>">previous page</a></td><%}%>
            <td width="18%"><%if(maxPage<=(number+1)){%>next page<%}else{%><a href="managerAction.do?action=1&i=<%=number+1%>  ">next page</a></td><%}%>
     <%if(sigh==1){%>

  ...
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <table width="610" height="25" border="0" cellpadding="0" cellspacing="0" background="image/bg_02.jpg">
          <tr>
            <td><div align="center"><strong>big type querying</strong></div></td>
          </tr>
        </table>
        <br>
	  <table width="90%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
        <tr>
          ...
          <td width="28%"><div align="center">createtime</div></td>
          <td width="30%"><div align="center">operation</div></td>
        </tr>
      ...
      previous page
        <%}else{%>
        <a href="bigTypeAction.do?action=0&i=<%=number-1%>">previous page</a></td>
          <%}%>
          <td width="18%"><%if(maxPage<=(number+1)){%>
            next page
              <%}else{%>
              <a href="bigTypeAction.do?action=0&i=<%=number+1%>  ">next page</a></td>
          <%}%>

          <td width="20%">
            <div align="right"><img src="image/bg-add.gif" width="9" height="9"><a href="bg-bigTypeInsert.jsp">&nbsp;add big type&nbsp;</a></div></td>

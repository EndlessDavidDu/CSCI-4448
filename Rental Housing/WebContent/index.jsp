                ...
                <tr>
                    ...
                    <td valign="top">
                        <table width="257" height="136" border="1" align="center" cellpadding="1" cellspacing="1"
                            ...
                            <tr>
                                <td width="33%" height="80" rowspan="5" bgcolor="#FFFFFF"><input name="pricture<%=i%>"
                                                                                                 type="image"
                                                                                                 src="<%=newGoods.getPriture()%>"
                                                                                                 width="140"
                                                                                                 height="126"></td>
                                <td width="67%" height="20" bgcolor="#FFFFFF">
                                    <div align="center"><%=newGoods.getName()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td height="20" bgcolor="#FFFFFF">
                                    <div align="center"><font color="#F14D83">current
                                        price：$<%=newGoods.getFreePrice()%>
                                    </font></div>
                                </td>
                            </tr>
                            <tr>
                                <td height="20" bgcolor="#FFFFFF">
                                    <div align="center"><%=newGoods.getIntroduce()%>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td height="13" bgcolor="#FFFFFF">
                                    <div align="center" class="linkBlack"><a href="#"
                                                                             onClick="window.open('goodsAction.do?action=16&id=<%=newGoods.getId()%>','','width=500,height=200');">view
                                        details</a></div>
                                </td>
                            </tr>
                        </table>
                                                        ...
                                                        <td width="36%" rowspan="4" bgcolor="#FFFFFF">
                                                            <div align="center">
                                                                <input name="pricture<%=i%>" type="image"
                                                                       src="<%=newGoods.getPriture()%>" width="110"
                                                                       height="100">
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#FFFFFF">
                                                            <div align="center"><font
                                                                    color="#F14D83">price：$<%=newGoods.getNowPrice()%>
                                                                </font></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td bgcolor="#FFFFFF" class="linkBlack" align="center">
                                                            ...
                                                            <a href="#"
                                                               onClick="window.open('goodsAction.do?action=16&id=<%=newGoods.getId()%>','','width=500,height=200');">view
                                                                details</a>
                                                            <%} else {%>
                                                            you can order only when you are logging in
                                                        </td>
                                                        <%}%>
                                                    </tr>
                                                </table>

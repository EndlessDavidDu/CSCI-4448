  ...
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <table width="610" height="25" border="0" cellpadding="0" cellspacing="0" background="image/bg_02.jpg">
          <tr>
            <td><div align="center"><strong>按special price商品信息查询</strong></div></td>
          </tr>
        </table>
        <br>
        ...
        <tr>
          ...
          <td width="14%"><div align="center">是否special price</div></td>
	  ...
	  previous page  
		...
		<a href="goodsAction.do?action=7&i=<%=number+1%>  &mark=<%=request.getParameter("mark")%>">next page</a>
<%}%>
        </tr>
      </table>

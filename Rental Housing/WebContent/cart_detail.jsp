  ...
  <tr>
	...
	<strong>order views</strong>
     ...
     <%}else{%>
       ...
       <tr align="center">
            <td width="15%" height="21">number</td>

            <td width="15%">telephone</td>
            <td width="21%">address</td>

            <td width="19%">odertime</td>
            <td width="18%">check in</td> <td width="12%">operation</td>
          </tr>
      <%
        ...
        %>
          <tr align="center">
            ...
            no<%}else{%>yes<%}%>
             ...
             <td><a href="cart_detail.jsp?number=<%=orderForm.getNumber()%>">view details</a></td>
          </tr>
...
<br>
      ...
      <table width="89%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#819BBC">
        ...
        <tr align="center">
          <td width="25%" height="21">number</td>

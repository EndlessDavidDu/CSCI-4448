            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr align="center">
                    ...
                    <td width="25%"><%if ((number + 1) == 1) {%>
                        previous page
                        <%} else {%>
                        <a href="linkAction.do?action=0&i=<%=number-1%>">previous page</a></td>
                    <%}%>
                    <td width="18%"><%if (maxPage <= (number + 1)) {%>
                        next page
                        <%} else {%>
                        <a href="linkAction.do?action=0&i=<%=number+1%>  ">next page</a></td>
                    <%}%>

                    <td width="20%">
                        <img src="image/bg-add.gif" width="9" height="9">&nbsp;<a href="bg-linkInsert.jsp">add
                        catering</a></td>

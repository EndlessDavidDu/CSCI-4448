            ...
            <table width="99%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF"
                ...
                <tr>
                    <td width="36%" rowspan="5" height="120">
                        <div align="center">
                            <input name="pricture<%=i%>" type="image" src="<%=freeGoods.getPriture()%>" width="140"
                                   height="126">
                        </div>
                    </td>
                    <td width="64%" height="30">
                        <div align="center"><%=freeGoods.getName()%>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td height="30">
                        <div align="center" style="text-decoration:line-through;color:#FF0000">original
                            price：<%=freeGoods.getNowPrice()%>元
                        </div>
                    </td>
                </tr>
                <tr>
                    <td height="30">
                        <div align="center">special price：<%=freeGoods.getFreePrice()%>元</div>
                    </td>
                </tr>
                <tr>
                    <td height="30">
                        <div align="center"><%=freeGoods.getIntroduce()%>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td height="30"
                        ...
                        <a href="#"
                           onClick="window.open('goodsAction.do?action=16&id=<%=freeGoods.getId()%>','','width=500,height=200');">view
                            details</a>
                        <%} else {%>you can order only login in<%}%></td>
                </tr>
            </table>
            <%}%><br>
                ...
                <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr align="center">
                        ...
                        <td width="15%"><%if ((number + 1) == 1) {%>
                            previous page
                            <%} else {%>
                            <a href="goodsAction.do?action=15&mark=1&i=<%=number-1%>">previous page</a></td>
                        <%}%>
                        <td width="14%"><%if (maxPage <= (number + 1)) {%>
                            next page
                            <%} else {%>
                            <a href="goodsAction.do?action=15&mark=1&i=<%=number+1%>  ">next page</a></td>
                        <%}%>
                        <td width="14%">
                            <div align="center"><a href="#" onClick="javasrcipt:history.go(-1);">back</a></div>
                        </td>
                    </tr>

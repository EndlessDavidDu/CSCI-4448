  ...
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <table width="610" height="25" border="0" cellpadding="0" cellspacing="0" background="image/bg_02.jpg">
          <tr>
            <td><div align="center"><strong>house big type querying</strong></div></td>
          </tr>
        </table>
        <br>
        ...
        <tr>
          ...
          <td width="19%"><div align="center">house name</div></td>
          <td width="14%"><div align="center">big type</div></td>
          <td width="14%"><div align="center">small type</div></td>
          <td width="14%"><div align="center">discount</div></td>
      ...
      %>
        <tr bgcolor="#FFFFFF">
          ...
          <td><div align="center"><a href="goodsAction.do?action=7&mark=<%=form.getMark()%>"><%if(form.getMark().toString().equals("0")){%>no<%}else{%>yes<%}%></a></div></td>
          <td><div align="center"><a href="goodsAction.do?action=5&id=<%=form.getId()%>">details</a>&nbsp;&nbsp;

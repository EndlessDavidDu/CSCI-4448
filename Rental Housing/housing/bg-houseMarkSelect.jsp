    ...
    <tr>
        ...
        <td width="618" align="center" valign="top" bgcolor="#FFFFFF"><br>
            ...
            <table width="610" height="25" border="0" cellpadding="0" cellspacing="0" background="image/bg_02.jpg">
                <tr>
                    <td>
                        <div align="center"><strong>by special price house information</strong></div>
                    </td>
                </tr>
            </table>
            <br>
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr align="center">
                    ...
                    <td width="20%"><%if ((number + 1) == 1) {%>
                        <%} else {%>
                        <a href="houseAction.do?action=7&i=<%=number-1%>&mark=<%=request.getParameter("mark")%>">Previous</a>
                    </td>
                    <%}%>
                    <td width="20%"><%if(maxPage<=(number+1)){%>
                            <%}else{%>

                        <a href="houseAction.do?action=7&i=<%=number+1%>  &mark=<%=request.getParameter("mark")%>">Next</a>
                            <%}%>
                </tr>
            </table>

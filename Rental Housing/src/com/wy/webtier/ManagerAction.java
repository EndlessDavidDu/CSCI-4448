...
public class ManagerAction
  ...
  public ActionForward execute(ActionMapping mapping,
    ...
    switch (action) {
      case 0: {
        return managerCheck(mapping, form, request, response); //判断manager login 后台
      }
      case 1: {
      ...
      case 4: {
        return managerDelete(mapping, form, request, response); //delete管理员信息
      }
      case 8: {
...
//modify manager password
  ...
  public ActionForward managerDelete(ActionMapping mapping,
    ...
    request.setAttribute("reslut", "delete此用户名成功！！！");

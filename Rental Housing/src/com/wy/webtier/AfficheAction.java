...
public class AfficheAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		case 2: {
			return afficheInsert(mapping, form, request, response); // add bulletin
		}
		case 3: {
			return afficheDelete(mapping, form, request, response); // 以数据库流水号为条件delete公告信息
		}
		case 4: {
	...
	public ActionForward afficheSelect(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) {
		List<Object> list = dao.selectAffiche();

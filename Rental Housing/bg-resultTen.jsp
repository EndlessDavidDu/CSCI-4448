	...
	<br><br>
      <%  for(int i=0;i<number;i++){
		...
		<table width="99%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#819BBC">
          ...
          <tr>
            <td height="21"><div align="center">price：<%=form.getNowPrice()%>元</div></td>
          </tr>
          <tr>
          ...
          <tr>
			...
			<a href="#" onClick="window.open('goodsAction.do?action=16&id=<%=form.getId()%>','','width=500,height=200');">See details</a>
            <%}else{%>
           You can't buy until you've logged in</td>
            <%}%>
          </tr>
        </table><br>
		<%}%>
